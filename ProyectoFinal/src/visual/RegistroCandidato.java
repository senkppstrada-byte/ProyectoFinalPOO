...
public class RegistroCandidato extends JDialog {
    ...
    public RegistroCandidato() {
        ...
        JLabel titulo = new JLabel("Registro de Candidato");
    ...
    private void construirFormulario(JPanel form) {
        ...
        form.add(new JLabel("Aspiración salarial:"));
        ...
        form.add(new JLabel("Años de experiencia (Técnico):"));
        spnExperiencia = new JSpinner(new SpinnerNumberModel(0, 0, 60, 1));
        form.add(spnExperiencia);

        form.add(new JLabel("Título (Profesional):"));
    ...
    public void registrar() {
        ...
        JOptionPane.showMessageDialog(this, "Candidato registrado. Ya puedes iniciar sesión.", "Listo",
